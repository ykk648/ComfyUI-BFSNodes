# Vendored from ComfyUI-RH-Bernini (https://github.com/RH-RunningHub/ComfyUI-RH-Bernini)
# Author: https://github.com/flybirdxx — License: GPL-3.0-only.
# This file (and therefore this package when distributed) is GPL-3.0.
# Provides the WanModel patch that consumes `context_latents` (source_id RoPE in-context).

"""
Runtime patches for ComfyUI PR #14216 (Bernini / Wan in-context conditioning).

Upstream: https://github.com/Comfy-Org/ComfyUI/pull/14216
"""
...
def apply_bernini_patches() -> bool:
    """Patch WanModel + WAN21 if Bernini support is not already in ComfyUI core."""
    global _PATCHED
    if _PATCHED:
        return True
